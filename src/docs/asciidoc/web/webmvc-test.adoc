...
* Spring MVC TestMain: A framework, also known as `MockMvc`, for testing annotated controllers
...
See <<testing.adoc#spring-mvc-test-framework, Spring MVC TestMain>> for more details.
